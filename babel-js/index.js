...
var categoryList = JSON.parse(localStorage.getItem("selectedCategories"));
var main = document.querySelector('main'); // const section = document.querySelector('.sectionCategory');
...
categoryList.forEach(function (element) {
  console.log(element);
  var categoryItem = element.category;
