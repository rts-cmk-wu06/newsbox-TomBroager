...
var main = document.querySelector('main'); // localStorage Array contains selected categories

var categoryList = JSON.parse(localStorage.getItem("selectedCategories")); // svg badge
...
categoryList.forEach(function (element) {
  console.log(element);
  var categoryItem = element.category; // creates selected categories components
  ...
  button.appendChild(arrowIcon); // creates categories article components
  ...
  h2Article.textContent = 'heading';
  divArticle.appendChild(h2Article);
  var article = document.createElement('article');
  article.textContent = 'Lorem ipsum dolor sit amet consectetur, adipisicing elit Lorem ipsum dolor sit amet consectetur, adipisicing elit.';
